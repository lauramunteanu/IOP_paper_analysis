...
def plot_EnuReco(filename: str, nEvents: int, IsReco: bool):
    ...
    # Eν^true (matches T2K flux native binning; finer widths show flux-
    # binning sawtooth artefacts).
...
plot_EnuReco("../../Remade_April26/nuwro_25031_morestats/HK/HK_nue_FSI.flat.root", nEvents = 1000000, IsReco = False)
plot_EnuReco("../../Remade_April26/nuwro_25031_morestats/HK/HK_nue_FSI.flat.root", nEvents = 1000000, IsReco = True)
