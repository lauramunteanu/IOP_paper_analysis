"""HK dm32 spectrum -- relative-energy-shift sibling of Fig1_dm32_plot.py.

Same as Fig1_dm32_plot.py but the +-5 MeV reco-energy shift is replaced by
a per-event +-0.5% * Enu_true shift via FlatTreeMod.smooth_shift_ratio
with a per-bin shift array.
"""
