...
def plot_EnuReco(nEvents, IsReco, IsdCP):
    ...
    if IsReco:
        if IsdCP:
            ...
            plt.savefig(outpath("Fig1_plots", "Fig1_DUNE_Enuhad_dCP_relshift.pdf"))
        else:
            ...
            ax.set_ylabel(EVENT_RATE_LABEL)
            ax_ratio.set_ylim(0.90, 1.1)
            plt.savefig(outpath("Fig1_plots", "Fig1_DUNE_Enuhad_dm32_relshift.pdf"))
    else:
        if IsdCP:
            ...
            ax.set_ylabel(EVENT_RATE_LABEL)
            ax_ratio.set_ylim(0.90, 1.1)
            plt.savefig(outpath("Fig1_plots", "Fig1_DUNE_EnuTrue_dCP_relshift.pdf"))
        else:
            ...
            ax.set_ylabel(EVENT_RATE_LABEL)
            ax_ratio.set_ylim(0.90, 1.1)
            plt.savefig(outpath("Fig1_plots", "Fig1_DUNE_EnuTrue_dm32_relshift.pdf"))
    plt.close(fig)
